    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommended_movie', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='recommended_movie', to='movies.Movie')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('similar_movie', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='similar_movie', to='movies.Movie')),
            ],
            options={
